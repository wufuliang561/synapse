...
export function ErrorDisplay({
  ...
  return (
    <div className={`mb-4 p-3 bg-red-50 border border-red-200 rounded-md ${className}`}>
...
export function SuccessDisplay({
  ...
  return (
    <div className={`mb-4 p-3 bg-green-50 border border-green-200 rounded-md ${className}`}>
      <div className="flex items-start">
        {showIcon && (
          <div className="flex-shrink-0">
            <svg
